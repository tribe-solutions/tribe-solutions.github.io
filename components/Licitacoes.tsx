          ...
          >
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
              {partners.map((p) => (
                ...
                >
                  <span className="inline-flex h-11 w-16 shrink-0 items-center justify-center rounded-lg border border-gold-500/30 bg-gold-500/10 font-display text-[10px] font-medium tracking-tight text-gold-300">
                    {p.acronym}
                  </span>
